...
(defpackage :pdf
  ...
  (:export
   ...
   #:enter-outline-level #:close-outline-level #:with-outline-level #:append-child-outline #:register-reference #:outline-root
   #:draw-centered-text #:draw-left-text #:draw-right-text
   #:vertical-value-axis #:horizontal-histo-axis #:legend #:histogram #:draw-object
   #:pie-chart #:plot-xy
   #:load-t1-font #:load-ttu-font #:load-ttf-file #:encoding #:get-encoding
